...
public struct Rectangle {
    ...
    public static implicit operator SKRectI(Rectangle r) => new SKRectI(r.Left, r.Top, r.Right, r.Bottom);
    public static implicit operator SKRect(Rectangle r) => new SKRect(r.Left, r.Top, r.Right, r.Bottom);
}
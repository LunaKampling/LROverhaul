    ...
    public class SpinnerG17 : ControlBase
    {
        ...
        public double Value
        {
            ...
            set
            {
                ...
                if (value.ToString("G17") != m_Textbox.Text)
                {
                    m_Textbox.Text = value.ToString("G17");
                }
            }
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SpinnerG17"/> class.
        /// </summary>
        /// <param name="parent">Parent control.</param>
        public SpinnerG17(ControlBase parent)
            : base(parent)
        {
            //   Padding = Padding.One;
